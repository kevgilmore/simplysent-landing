const Testimonials = () => {
  ...
  <div className="w-full mx-auto">
    ...
    <div className="mt-20 md:w-4/5 mx-auto ">
      <div className="relative grid grid-cols-1 md:grid-cols-3 gap-12 pb-12">
        <div className="w-full bg-white drop-shadow-sm  rounded-md px-4 py-8">
          <div className="flex flex-col items-center px-6">
            <span className="font-extrabold text-center block text-6xl text-[#007AFF] text-center">
              <svg
                fill="#0E004A"
                height="1em"
                viewBox="0 0 16 16"
