    ...
    const setupLenis = useCallback(() => {
        if (useWindowScroll) {
            ...
            const onWheel = (e) => {
                ...
                // If at boundary and exiting, stop propagation immediately to prevent Lenis from handling it
                // This allows native scroll chaining to occur
                if ((isAtTop && e.deltaY < 0) || (isAtBottom && e.deltaY > 0)) {
                    e.stopImmediatePropagation();
                }
            };

            // Add listener BEFORE Lenis initialization
